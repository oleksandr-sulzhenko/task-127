...
public abstract class BasePage<T> {
    ...
    /**
      * Waits for the page to unload using JS:
      * until `document.readyState` becomes != `complete`
      */
    public void waitToPageUnloadByDocumentReadyState() {
        driverWait.until((ExpectedCondition<Boolean>) driver ->
                !((JavascriptExecutor) driver).executeScript("return document.readyState").equals("complete"));
    }

    public void waitToElementUnload(By locator) {
